...
(function () {
	...
	function setDefaultAttribute() {
		if (!sessionStorage.getItem("defaultAttribute")) {
            ...
            sessionStorage.setItem("data-preloader", "enable");
            sessionStorage.setItem("data-body-image", "none");
            sessionStorage.setItem("data-body-visibility", "show");
			...
			var isLayoutAttributes = {};
			isLayoutAttributes["data-layout"] = 'vertical';
			isLayoutAttributes["data-sidebar-size"] = 'lg';
			isLayoutAttributes["data-layout-mode"] = 'light';
			isLayoutAttributes["data-layout-width"] = 'fluid';
			isLayoutAttributes["data-sidebar"] = 'light';
			isLayoutAttributes['data-sidebar-image'] = 'none';
			isLayoutAttributes["data-layout-position"] = 'fixed';
			isLayoutAttributes["data-layout-style"] = 'default';
			isLayoutAttributes["data-topbar"] = 'light';
			isLayoutAttributes["data-preloader"] = 'enable';
			isLayoutAttributes["data-body-image"] = 'none';
			isLayoutAttributes["data-body-visibility"] = 'show';
			layoutSwitch(isLayoutAttributes);
		}
	}
